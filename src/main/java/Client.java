...
public class Client {
    public static void main(String[] args) throws Exception {
        System.out.println("-----Cron Parser Started----");
        ...
        do {
            ...
            System.out.println("Give expression space separated, supported only Min Hour Day_Of_Month Month Day_of_Week \n");
            line = reader.readLine();
     ...
     //   System.out.println("result === " + parser.parse("2-5 1-5"));
      ...
      //  System.out.println(" Parser result : \n " + cronParser.parse(args[0]));
       ...
       // System.out.println("result === " + parser.parse("*/1/5 0 1,15 * 1-5 /usr/bin/find"));
        ...
        System.out.println("-----Cron Parser Completed----");
